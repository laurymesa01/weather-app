...
const Search = () => {
  return (
    <form action="" className='mt-12 flex flex-col items-center gap-2 md:flex-row lg:justify-center'>
      <div className='search-input'>
        ...
        <input id="search" type="search" placeholder='Search for a place...' className='text-preset-5-medium outline-none focus:outline-none w-full '/>
      </div>
