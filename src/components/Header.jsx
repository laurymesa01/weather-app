...
const Header = () => {
  ...
  return (
    <header className="flex items-center justify-between relative">
      ...
      <button
        ref={triggerRef}
        className="group flex items-center gap-2 bg-neutral-800 p-2 rounded-md cursor-pointer focus:border focus:border-neutral-0 focus:shadow-md focus:shadow-neutral-900"
      ...
      {isDropdownOpen && <Units setIsDropdownOpen={setIsDropdownOpen} triggerRef={triggerRef} />}
    </header>
  )
}
