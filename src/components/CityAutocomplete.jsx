...
const CityAutocomplete = ({suggestions, onSelect, isLoadingCitiesSuggestions}) => {

  console.log(isLoadingCitiesSuggestions)
  
  
  return (
    <div id="dropdown" className="z-10 w-full absolute top-full left-0 mt-2 animate-dropdown-open origin-top">
        {isLoadingCitiesSuggestions ? ( 
            <div className='bg-neutral-800 rounded-xl flex flex-row items-center gap-2 p-3 border border-neutral-600'>
