...
const CityAutocomplete = ({suggestions, onSelect, isLoadingCitiesSuggestions, suggestionsError, activeIndex, setActiveIndex}) => {
  ...
  return (
    <div id="search-suggestions" className="z-10 w-full absolute top-full left-0 mt-2 animate-dropdown-open origin-top">
        {suggestionsError ? (
            <div role="alert" className="bg-neutral-800 rounded-xl flex flex-row items-center gap-2 p-3 border border-neutral-600">
              <p className="text-preset-7 text-neutral-200">Could not load suggestions. Try typing your search and press Enter.</p>
            </div>
