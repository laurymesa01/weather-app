...
const Error = () => {
  ...
  return (
    <div role="alert" className="flex flex-col items-center text-center gap-4 mt-20">
        ...
        <p className="text-preset-5-medium text-neutral-200">We couldn&apos;t connect to the server (API error). Please try again in a few moments.</p>
        <button onClick={retry} className="bg-neutral-800 rounded-lg p-3 flex flex-row gap-2 cursor-pointer">
